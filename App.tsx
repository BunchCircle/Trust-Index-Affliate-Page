    ...
    <div className="min-h-screen flex flex-col font-sans selection:bg-green-100 selection:text-green-900 bg-[#FBF9F6]">
      ...
      <nav className={`fixed top-0 left-0 w-full z-50 bg-white/95 backdrop-blur-sm border-b border-gray-100 transition-all duration-300 transform ${scrolled ? 'translate-y-0' : '-translate-y-full'}`}>
        <div className="max-w-6xl mx-auto px-4 h-20 flex items-center justify-between">
          <div className="flex items-center space-x-3 cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
            ...
            <span className="font-extrabold text-2xl tracking-tighter">Trustindx</span>
          </div>
      ...
      <Section className="text-center !pt-12 md:!pt-24 relative overflow-hidden">
        ...
        <h1 className="text-4xl md:text-6xl font-black text-gray-900 leading-tight mb-8 tracking-tighter">
          ...
          <span className="text-red-600 relative inline-block">Cost You Customers,<div className="absolute -bottom-2 left-0 w-full h-4 bg-red-100 -z-10 -rotate-1 opacity-70"></div></span><br />
        ...
        <div className="flex flex-col items-center space-y-8 mb-24">
          <PrimaryButton onClick={handleConversionClick}>
        ...
        <div className="relative w-full max-w-6xl mx-auto group">
          ...
          <div className="mt-8 md:mt-12 mx-auto max-w-4xl relative z-10">
            <div className="bg-white p-8 md:p-10 rounded-3xl shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] border border-gray-100 flex flex-col md:flex-row items-center md:items-start text-left md:space-x-8 hover:border-green-100 transition-colors duration-300">
              <div className="flex-shrink-0 bg-green-50 p-6 rounded-2xl text-[#198F65] mb-6 md:mb-0">
              ...
              <div>
                ...
                <h3 className="text-xl md:text-2xl font-black text-gray-900 mb-2 leading-tight">The "Google Maps" Dominator</h3>
                <p className="text-base text-gray-500 font-semibold leading-relaxed">Systematically collects reviews on Google, Yelp, and Facebook to push your local ranking to the top of search results.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white/30 backdrop-blur-sm py-16 border-y border-gray-100 overflow-hidden whitespace-nowrap relative">
        ...
        <div className="animate-marquee inline-block">
          {[...LOGO_MARQUEE, ...LOGO_MARQUEE].map((logo, i) => (
            <span key={i} className="text-xl md:text-3xl font-black text-gray-300 mx-12 md:mx-20 uppercase tracking-tighter hover:text-[#198F65] transition-colors cursor-default select-none">
              {logo}
            </span>
          ))}
        </div>
      ...
      <Section className="bg-transparent">
        <div className="text-center mb-16">
          <span className="text-[#198F65] font-black text-xs uppercase tracking-[0.4em] mb-4 block">The Invisibility Trap</span>
          <h2 className="text-4xl md:text-5xl font-black text-gray-900 tracking-tighter leading-tight">Your Local Business <br />"Blind Spot"</h2>
          <p className="text-lg text-gray-500 mt-6 font-semibold italic">If your competitor has 15 more 5-star reviews than you, you are losing money every hour.</p>
        </div>

        <div className="grid md:grid-cols-2 gap-16">
          <div className="bg-white rounded-3xl p-12 border border-gray-100 relative overflow-hidden group hover:bg-red-50/30 transition-colors">
            <div className="absolute top-0 right-0 bg-red-500 text-white px-8 py-3 rounded-bl-2xl font-black text-xs uppercase tracking-widest">Static Reputation</div>
            <div className="space-y-10 opacity-40 grayscale group-hover:opacity-60 transition-opacity">
              ...
              <div className="h-56 w-full bg-gray-100 rounded-3xl flex flex-col items-center justify-center border-2 border-dashed border-gray-300">
            ...
            <p className="mt-14 text-red-600 font-black flex items-center text-xl tracking-tight">
              <AlertTriangle className="w-8 h-8 mr-4" /> Visitors Assume You're Closed
            </p>
          ...
          <div className="bg-[#198F65] rounded-3xl p-12 shadow-[0_40px_100px_-20px_rgba(25,143,101,0.3)] relative overflow-hidden group hover:scale-[1.02] transition-transform duration-500">
            ...
            <div className="space-y-10">
              ...
              <div className="h-56 w-full bg-white/10 backdrop-blur-md rounded-3xl flex flex-col items-center justify-center p-10 border border-white/20 shadow-inner">
                ...
                <div className="text-green-200 text-sm font-black mt-4 uppercase tracking-[0.2em] opacity-80">Review Posted 4h ago</div>
              </div>
            </div>
            <p className="mt-14 text-white font-black flex items-center text-xl tracking-tight">
              <CheckCircle className="w-8 h-8 mr-4 text-green-400" /> Dominate Local Search
            </p>
      ...
      <Section className="bg-[#FBF9F6]">
        <div className="max-w-4xl mx-auto text-center mb-16">
          <span className="text-[#198F65] font-black text-xs uppercase tracking-[0.4em] mb-4 block">The Solution Suite</span>
          <h2 className="text-4xl md:text-5xl font-black text-gray-900 tracking-tighter leading-tight">Your Reputation "Engine"</h2>
          <p className="text-lg text-gray-500 mt-6 font-semibold">We help local businesses solve the 4 biggest reputation bottlenecks.</p>
        </div>
        <div className="grid md:grid-cols-2 gap-10 max-w-6xl mx-auto">
          {[
            ...
            <div key={i} className="p-12 bg-white border border-gray-100 rounded-3xl flex items-start space-x-8 hover:shadow-2xl hover:border-green-100 transition-all group">
              <div className="p-5 bg-green-50 text-[#198F65] rounded-2xl group-hover:bg-[#198F65] group-hover:text-white transition-colors">
              ...
              <div>
                <h4 className="font-black text-gray-900 mb-2 text-xl tracking-tight">{item.type}</h4>
                <p className="text-base text-gray-500 leading-relaxed font-semibold">{item.desc}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      <Section className="bg-white rounded-3xl border border-gray-100 shadow-xl overflow-hidden relative">
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
              ...
              {[
                ...
                <div key={i} className="flex items-start space-x-6 group">
                  ...
                  <div className="border-b border-gray-50 pb-4 w-full">
                    <h4 className="text-lg font-black text-gray-900 mb-1 tracking-tight group-hover:text-[#198F65] transition-colors">{item.title}</h4>
                    <p className="text-base text-gray-500 font-semibold leading-relaxed">{item.desc}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="relative group lg:block hidden">
            <div className="absolute -inset-6 bg-green-50 rounded-3xl -z-10 transform rotate-2 group-hover:rotate-0 transition-transform duration-700"></div>
            <div className="bg-gray-50 rounded-3xl p-16 border border-gray-100 shadow-inner flex flex-col items-center justify-center text-center space-y-10">
              ...
              <div>
                <p className="text-4xl font-black text-gray-900 tracking-tighter">0 Hours</p>
                <p className="text-xs font-black text-gray-400 uppercase tracking-[0.3em] mt-2">Manual Work Per Month</p>
              </div>
              <div className="w-full h-px bg-gray-200"></div>
              <div className="flex space-x-3 scale-110">
                {[...Array(5)].map((_, i) => <Star key={i} className="w-8 h-8 text-yellow-400 fill-current" />)}
              </div>
              <p className="text-base text-gray-500 font-bold italic leading-relaxed px-6">
        ...
        <div className="grid md:grid-cols-3 gap-20 relative">
          ...
          {[
            ...
            <div key={i} className="text-center group">
              <div className="w-36 h-36 bg-[#198F65] rounded-3xl flex items-center justify-center text-white mx-auto mb-10 shadow-2xl transform group-hover:-translate-y-4 transition-transform relative">
                {s.icon}
              ...
              <p className="text-base text-gray-500 font-semibold leading-relaxed px-4">{s.desc}</p>
            </div>
          ))}
        </div>
      </Section>
      ...
      <Section className="bg-gray-950 text-white rounded-t-[5rem] overflow-hidden relative">
        <div className="absolute inset-0 bg-[#198F65]/5 -z-10 animate-pulse"></div>
        <div className="grid md:grid-cols-2 gap-24 items-center">
          <div>
            <span className="text-green-400 font-black text-xs uppercase tracking-[0.5em] mb-6 block">The Silent Business Killer</span>
            <h2 className="text-4xl md:text-6xl font-black mb-8 leading-[0.95] tracking-tighter">Your Poor Rating is <br />a Competitor's Asset.</h2>
            <div className="space-y-10">
              {[
                ...
                <div key={i} className="flex items-start space-x-6">
                  ...
                  <p className="text-xl text-gray-300 font-semibold italic leading-relaxed">"{text}"</p>
                </div>
              ))}
            </div>
            <div className="mt-16 p-12 bg-white/5 border-l-[14px] border-[#198F65] rounded-r-3xl backdrop-blur-sm">
              <p className="text-green-400 font-black uppercase text-xs tracking-widest mb-3">The Brutal Reality</p>
              <p className="text-xl text-gray-200 font-bold leading-relaxed tracking-tight">Your customers are talking about you. If you aren't part of that conversation, you're handing over your local market share.</p>
            </div>
          </div>
          <div className="bg-white rounded-3xl p-16 md:p-20 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5)] text-center relative overflow-hidden">
            <div className="absolute top-0 right-0 w-64 h-64 bg-green-500/10 rounded-full -translate-y-1/2 translate-x-1/2 blur-3xl"></div>
            <div className="mb-12">
              <div className="w-24 h-24 bg-green-50 text-[#198F65] rounded-2xl flex items-center justify-center mx-auto mb-10">
                <Rocket className="w-12 h-12" />
              </div>
              <h3 className="text-4xl font-black text-gray-900 mb-6 tracking-tighter leading-tight">Start Dominating.</h3>
              <p className="text-gray-500 mb-10 text-xl leading-relaxed font-semibold">Turn your reputation into a local lead-gen machine today.</p>
            </div>
            <PrimaryButton onClick={handleConversionClick} className="w-full">
              Start My Free Trial
            </PrimaryButton>
      ...
      <Section id="faq" className="bg-transparent">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-24">
            <span className="text-[#198F65] font-black text-xs uppercase tracking-[0.5em] mb-4 block">Protect Your Investment</span>
            <h2 className="text-4xl md:text-5xl font-black text-gray-900 tracking-tighter leading-tight">Local Biz Questions</h2>
          </div>
          <div className="space-y-8">
            {[
              ...
              <div key={i} className="bg-white border border-gray-200 rounded-3xl overflow-hidden shadow-sm hover:shadow-xl hover:border-green-100 transition-all">
                <button onClick={() => toggleFaq(i)} className="w-full p-10 md:p-12 flex items-center justify-between text-left group">
                  <span className="text-xl font-black text-gray-900 group-hover:text-[#198F65] transition-colors tracking-tight leading-tight">{item.q}</span>
                ...
                <div className={`overflow-hidden transition-all duration-500 ease-in-out ${openFaq === i ? 'max-h-[600px] opacity-100 pb-12 px-10 md:px-12' : 'max-h-0 opacity-0'}`}>
                  ...
                  <p className="text-gray-500 font-semibold text-base leading-relaxed">{item.a}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      {/* --- FINAL CTA --- */}
      <Section className="bg-[#198F65] text-white rounded-t-[5rem] text-center overflow-hidden relative pb-40">
        <div className="absolute inset-0 bg-gray-900/10 -z-10"></div>
        <div className="max-w-5xl mx-auto relative px-6">
          <h2 className="text-5xl md:text-7xl font-black mb-8 leading-[0.9] tracking-tighter">Become the <br />Local <span className="text-gray-900 italic">Leader.</span></h2>
          <p className="text-lg md:text-2xl text-green-100 mb-12 max-w-2xl mx-auto font-semibold leading-relaxed tracking-tight">
            Stop losing local customers to competitors with better reviews. Secure your reputation today.
          </p>
          <div className="flex flex-col items-center">
            <PrimaryButton onClick={handleConversionClick} className="mb-12 bg-white !text-[#198F65] hover:!bg-gray-50 !shadow-2xl">
      ...
      <footer className="bg-gray-950 py-40 px-6 text-center">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center justify-center space-x-3 mb-16 opacity-50 grayscale hover:opacity-100 hover:grayscale-0 transition-all cursor-pointer">
            <span className="font-extrabold text-4xl tracking-tighter text-white">Trustindx</span>
          </div>
